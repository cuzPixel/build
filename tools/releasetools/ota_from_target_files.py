...
""" % bcb_dev)
  ...
  build_date = target_info.GetBuildProp("org.cuzpixel.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.cuzpixel.device")
  script.PrintCuzPixelBanner(android_version, build_id, build_date,
